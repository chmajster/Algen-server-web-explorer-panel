...
- Docker manager schema migration `user_version=2`, automatic removal of legacy registry plaintext into private secret files, one-time private secret inputs, separate Compose secret environments, seven-day statistics history, granular Docker RBAC and PAM/exact-confirmation gates for high-risk operations.
