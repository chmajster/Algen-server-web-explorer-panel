...
Samba is the reference implementation. Nginx, Squid Proxy, and Syncthing use the generic shell for the capabilities their manifests declare and can gain dedicated providers without changing Package Center, window persistence, or the job schema.
