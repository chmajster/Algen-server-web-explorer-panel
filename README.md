...
- Complete **Containers Manager** for official Docker Engine installation/update, local images, a Docker Hub/Registry V2 image catalog with tag-aware pulls, registry connections, Compose projects/history/scaling, volumes, networks, application templates, backups, diagnostics, granular RBAC and high-risk PAM confirmations.
