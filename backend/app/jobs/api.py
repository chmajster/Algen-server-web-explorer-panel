...
def list_jobs(status: JobStatus | None = None, module: str | None = Query(default=None, max_length=96),
              type: str | None = Query(default=None, max_length=96), created_by: str | None = Query(default=None, max_length=128),
              since: float | None = Query(default=None, ge=0), until: float | None = Query(default=None, ge=0),
