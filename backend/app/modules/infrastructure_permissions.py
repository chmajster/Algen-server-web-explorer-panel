...
PERMISSION_DEFAULTS: dict[str, tuple[str, PermissionRisk, bool, tuple[Role, ...]]] = {
    ...
    "ntp.service.control": ("ntp-manager", PermissionRisk.critical, True, (Role.admin, Role.operator)),
    "ntp.sync": ("ntp-manager", PermissionRisk.critical, True, (Role.admin, Role.operator)),
    "ntp.firewall.manage": ("ntp-manager", PermissionRisk.critical, True, (Role.admin,)),
