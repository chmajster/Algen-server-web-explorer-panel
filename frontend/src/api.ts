...
export type PermissionMetadata = { id: string; category: string; operation: string; risk: PermissionRisk; mutating: boolean; label_key: string; description_key: string };
