...
const handlers = () => ({
  onToggleLauncher: vi.fn(), onToggleNotifications: vi.fn(), onToggleActions: vi.fn(), onToggleCalendar: vi.fn(), onOpenLocalPanel: vi.fn(), onToggleTheme: vi.fn(), onApp: vi.fn(), onModule: vi.fn(), onOpenNew: vi.fn(), onOpenModuleNew: vi.fn(), onTogglePin: vi.fn(), onToggleModulePin: vi.fn(), onWindow: vi.fn(), onCloseApp: vi.fn(), onCloseModule: vi.fn(), onTaskbarSettings: vi.fn(), onAlignment: vi.fn(), onLogout: vi.fn(),
});
