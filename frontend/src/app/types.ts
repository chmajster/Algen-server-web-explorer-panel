...
export type ToastFn = (text: string, type?: "ok" | "error", category?: "general" | "admin" | "transfer" | "rbac", moduleId?: string) => void;
...
export type Toast = { id: number; text: string; type: "ok" | "error"; category?: "general" | "admin" | "transfer" | "rbac"; moduleId?: string };
