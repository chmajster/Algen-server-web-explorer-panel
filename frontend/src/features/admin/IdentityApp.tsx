...
function UserDetails({ user, metadata, can, t, onClose, onDialog, perform, onOpenPolicies }: { user: IdentityUser; metadata: PermissionMetadata[]; can: (permission: string) => boolean; t: Translate; onClose: () => void; onDialog: (value: Dialog) => void; perform: (action: () => Promise<unknown>) => Promise<void>; onOpenPolicies?: (subject: PolicySubject) => void }) {
...
function GroupDetails({ group, metadata, can, t, onClose, onDialog, perform, onOpenPolicies }: { group: IdentityGroup; metadata: PermissionMetadata[]; can: (permission: string) => boolean; t: Translate; onClose: () => void; onDialog: (value: Dialog) => void; perform: (action: () => Promise<unknown>) => Promise<void>; onOpenPolicies?: (subject: PolicySubject) => void }) {
