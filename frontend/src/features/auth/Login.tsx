...
export function Login({ language, onLogin }: { language: Language; onLogin: (user: User) => void }) {
  ...
  return <main className="login-screen">
    <form className="login-panel" onSubmit={submit} aria-busy={loading}>
      ...
      <div className="login-error-slot">{error && <div id="login-error" className="login-error" role="alert" aria-live="polite"><CircleAlert aria-hidden="true" /><span>{error}</span></div>}</div>
