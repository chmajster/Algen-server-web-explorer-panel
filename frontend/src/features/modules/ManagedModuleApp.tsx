import { Archive, Boxes, CircleAlert, CircleCheckBig, Database, Download, FileText, Gauge, Link, PackageCheck, Play, RefreshCw, RotateCcw, Save, Shield, Square, Stethoscope, Wrench } from "lucide-react";
