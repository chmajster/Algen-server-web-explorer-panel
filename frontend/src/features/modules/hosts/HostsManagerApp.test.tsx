...
vi.mock("../../../api", async () => {
  ...
  return { ...actual, api: { ...actual.api, hostsManagerDashboard: vi.fn(), hostsManagerSettings: vi.fn(), saveHostsManagerSettings: vi.fn(), hostsManagerHosts: vi.fn(), hostsManagerGroups: vi.fn(), hostsManagerEnvironments: vi.fn(), hostsManagerApmids: vi.fn(), hostsManagerHostnamePatterns: vi.fn(), hostsManagerEnrollmentTokens: vi.fn(), hostsManagerOperations: vi.fn(), hostsManagerCredentials: vi.fn(), saveHostsManagerCredential: vi.fn(), deleteHostsManagerCredential: vi.fn(), saveHostsManagerCredential: vi.fn(), deleteHostsManagerCredential: vi.fn(), hostsManagerRepositories: vi.fn(), hostsManagerPowerProfiles: vi.fn(), hostsManagerDiagnostics: vi.fn(), hostsManagerBackups: vi.fn(), hostsManagerCapabilities: vi.fn(), saveHostsManagerHost: vi.fn(), createHostsManagerEnrollmentToken: vi.fn(), downloadHostsManagerEnrollmentScript: vi.fn() } };
});
...
describe("HostsManagerApp", () => {
  ...
  it("shows credential fields dynamically for the selected type", async () => {
