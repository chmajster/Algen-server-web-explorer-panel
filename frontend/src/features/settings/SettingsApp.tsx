...
const categorySettings: Record<SettingsCategory, string[]> = {
  ...
  identity: ["usersAndGroups"], network: ["networkMonitor", "dnsDiagnostics", "routingTable"], networkResources: ["networkResources"], updates: ["updates", "updateStatus", "webnasUpdates", "npmPackages", "npmPackagesFrontend", "updateNpmNow"], policies: ["updatePolicies", "automaticUpdateChecks", "updateInterval", "automaticUpdates", "automaticNpmUpdates", "updateConfiguration", "containerDefaultsPolicy", "networkConfirmationTimeout"], administration: ["serviceInformation", "proxmoxSafeMode"], about: ["applicationName", "version", "technologies", "license", "repository"],
};
