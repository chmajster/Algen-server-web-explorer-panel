...
export default [
  { id: "modules", labelKey: "app.modules", icon: <Boxes />, category: "system", permission: "modules.view", minWidth: 760, minHeight: 500, render: (context) => lazyView(<ModuleHub permissions={context.profile.permissions} t={context.t} toast={context.toast} onOpen={(moduleId) => context.openApp("module", undefined, moduleId)} />, context.t("status.loading")) },
