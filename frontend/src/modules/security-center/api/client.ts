...
export type Summary = { score: number | null; findings: number; last_scan: number | null; severity: Record<string, number>; areas: Record<string, { score: number; findings: number; critical: number; high: number }>; metrics: Record<string, Record<string, unknown>> };
